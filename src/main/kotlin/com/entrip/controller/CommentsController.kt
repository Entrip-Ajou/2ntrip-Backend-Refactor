...
class CommentsController(
    ...
    public fun update(
        ...
        @RequestBody requestDto: CommentsUpdateRequestDto
    ...
    public fun findById(@PathVariable comment_id: Long): ResponseEntity<RestAPIMessages> {
    ...
    public fun getAllCommentsWithPlanId(@PathVariable plan_id: Long): ResponseEntity<RestAPIMessages> {
