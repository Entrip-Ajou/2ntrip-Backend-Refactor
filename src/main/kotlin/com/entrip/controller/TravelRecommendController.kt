...
import com.entrip.domain.dto.TravelRecommendRequestDto.TravelRecommendRequestDto
...
class TravelRecommendController(
    ...
    fun execPython(@RequestBody requestDto: TravelRecommendRequestDto): ResponseEntity<RestAPIMessages> {
        return sendResponseHttpByJson(
            "TravelRecommend!",
            travelRecommendService.callPython(requestDto.user_id, requestDto.region, requestDto.recommendType)
        )
    }
}