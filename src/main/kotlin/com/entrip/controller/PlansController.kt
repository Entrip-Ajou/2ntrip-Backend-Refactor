...
class PlansController(
    ...
    public fun save(@RequestBody requestDto: PlansSaveRequestDto): ResponseEntity<com.entrip.domain.RestAPIMessages> {
    ...
    public fun findById(@PathVariable plan_id: Long): ResponseEntity<RestAPIMessages> {
        val responseDto = plansService.findById(plan_id)
        val returnDto = PlansReturnDto(responseDto)
    ...
    public fun delete(@PathVariable plan_id: Long): ResponseEntity<RestAPIMessages> {
